...
if ((resolution >= 2160)); then
    ...
    wlogout -l ~/.config/wlogout/layout_mango --protocol layer-shell -b 6 -T $T_val -B $B_val &
    ...
    wlogout -l ~/.config/wlogout/layout_mango --protocol layer-shell -b 3 -T $T_val -B $B_val &
else
    echo "Setting default parameters"
    wlogout -l ~/.config/wlogout/layout_mango &
fi
